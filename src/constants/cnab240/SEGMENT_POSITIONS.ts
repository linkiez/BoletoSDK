...
export const FILE_HEADER_POSITIONS = {
  ...
  BANK_NAME: { start: 104, end: 133 },
  RESERVED_2: { start: 134, end: 143 },
  FILE_CODE: { start: 144, end: 144 },
  GENERATION_DATE: { start: 145, end: 152 },
  GENERATION_TIME: { start: 153, end: 158 },
  FILE_SEQUENCE: { start: 159, end: 164 },
  LAYOUT_VERSION: { start: 165, end: 167 },
  FILE_DENSITY: { start: 168, end: 172 },
  RESERVED_BANK: { start: 173, end: 192 },
  RESERVED_COMPANY: { start: 193, end: 212 },
  RESERVED_3: { start: 213, end: 240 },
} as const;
